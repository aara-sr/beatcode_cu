  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{
      ...
      <div className="bg-black/60 backdrop-blur-lg rounded-sm shadow-lg p-10 w-full max-w-md flex flex-col items-center" style={{boxShadow: '0 8px 16px -1px rgba(0, 0, 0, 0.5)'}}>
        <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-purple-600 to-pink-500 animate-gradient mb-8 drop-shadow-lg">Login to BeatCode</h1>
        <form onSubmit={handleSubmit} className="space-y-6 w-full">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 hover:from-blue-700 hover:to-pink-600 text-white font-bold py-3 rounded-sm text-xl shadow-xl transition-all duration-300 hover:scale-105"
            disabled={loading}
          >
        ...
        <div className="mt-6 text-center text-sm text-gray-300">
          Don&apos;t have an account? <a href="/register" className="text-blue-300 hover:text-blue-200 transition-colors">Register</a>
        </div>
      </div>
    </div>
  );
